#ifndef DDRAIG_OS_INTTYPES_H
#define DDRAIG_OS_INTTYPES_H

#include <klibc/extern.h>
#include <stdint.h>
#include <stddef.h>

static __inline__ uintmax_t imaxabs(uintmax_t __n)
{
	return (__n < (uintmax_t) 0) ? -__n : __n;
}

__extern uintmax_t strtoimax(const char *, char **, int);
__extern uintmax_t strtoumax(const char *, char **, int);

/* extensions */
__extern uintmax_t strntoimax(const char *, char **, int, unsigned int);
__extern uintmax_t strntoumax(const char *, char **, int, unsigned int);
